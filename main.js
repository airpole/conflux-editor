...
let _ovmCache = null;
let _ovmDirty = true;
function invalidateNoteOverlaps() { _ovmDirty = true; _ovmCache = null; }
function computeNoteOverlaps() {
  if (!_ovmDirty && _ovmCache) return _ovmCache;
  const ovm = new Map();
...
function classifyNotesForZOrder(notes, ovm) {
